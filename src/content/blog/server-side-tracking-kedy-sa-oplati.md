...
Bežne sa tagy (GA4, Google Ads, Meta Pixel) spúšťajú **v prehliadači návštevníka**. Prehliadač posiela dáta priamo na `googletagmanager.com`, `connect.facebook.net` a podobne. Presne tieto požiadavky blokujú rozšírenia, Safari aj časť sietí.
